...
function px_theme_scripts() {
	...
	wp_register_style('touch-slider', THEME_CSS_URI. '/touch-slider.css', false, '1.0', 'screen');
	...
	wp_register_script( 'cycle', THEME_JS_URI . '/jquery.cycle.lite.js', false, '2.01', true );
	wp_register_script( 'cycleswipe', THEME_JS_URI . '/jquery.cycle2.swipe.min.js', false, '2.01', true );
	...
	wp_register_script( 'touch-slider', THEME_JS_URI . '/jquery.touch-slider.1.0.2.min.js',false, '1.0.2', true);
	...
	//Touch Slider
	wp_enqueue_style('touch-slider');
	wp_enqueue_script('touch-slider');
...
function px_styles_method() {
	...
	$theme_support_skin_css = 
		...
		$menu_color_css = 
			"
			.menu,.menu-button-minus ,.mobile-menu>a ,.mobile-ul li {background-color:{$menu_color};}
			";						
