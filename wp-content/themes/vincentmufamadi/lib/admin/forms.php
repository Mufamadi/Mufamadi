				...
				<div id="px-sidebar-accordion">
					...
					<div>
						<ul class="px-tab">
							...
							<li><a href="#custom_Part-settings"><?php _e('Custom Part', TEXTDOMAIN); ?></a></li>
							<li><a href="#resume-settings"><?php _e('Resume', TEXTDOMAIN); ?></a></li>
			...
			<div id="px-main">
				...
				<div id="contact-settings" class="panel">
					...
					<div class="section">
						<div class="section-head">
						  <div class="section-tooltip">
							<?php _e('Enter contact label here that will appear in the header navigation , intro navigation and contact title.', TEXTDOMAIN); ?>
						  </div>
						  <div class="label">
							<?php _e('Contact Label', TEXTDOMAIN); ?>
						  </div>
						</div>

						<?php TextInput('contact_label', 'Contact label', 'field-spacer'); ?>
					...
					<div class="section-head">
					  <div class="section-tooltip">
						<?php _e('Enable or disable contact Section', TEXTDOMAIN); ?>
					  </div>
					  <div class="label">
						<?php _e('Contact Display', TEXTDOMAIN); ?>
					  </div>
					</div>

						<?php SwitchInput('contact_display', 'Disabled', 'Enabled'); ?>
				...
				<div id="portfolio-settings" class="panel">
					<div class="content-head">
		  			...
		  			<!-- Enabel Display portfolio -->
					<div class="section">
					  <div class="section-head">
						<div class="section-tooltip">
						  <?php _e('Enable or disable portfolio section', TEXTDOMAIN); ?>
						</div>
						<div class="label">
						  <?php _e('Portfolio Display', TEXTDOMAIN); ?>
						</div>
					  </div>

					  <?php SwitchInput('portfolio_display', 'Disabled', 'Enabled'); ?>
					</div>
					<!-- Enabel Display Portfolio End -->
					
					<!--portfolio label -->
					<div class="section">
					<div class="section-head">
					  <div class="section-tooltip">
						<?php _e('Enter portfolio section title here.', TEXTDOMAIN); ?>
					  </div>
					  <div class="label">
						<?php _e('Portfolio label', TEXTDOMAIN); ?>
					  </div>
					</div>

					<?php TextInput('portfolio_label', 'portfolio label', 'field-spacer'); ?>
				...
				<div id="custom_Part-settings" class="panel">
					<div class="content-head">
						<h3><?php _e('Custom Part Settings', TEXTDOMAIN); ?></h3>
						 <a href="#" class="save-button" ><span class="save">save</span>
							<div class="tooltip">
								<div><?php _e('SAVE', TEXTDOMAIN); ?></div>
							</div>
		  			...
		  			<!-- Enabel Display Custom Part  -->
					<div class="section">
					  <div class="section-head">
						<div class="section-tooltip">
						  <?php _e('Enable or disable custom part section', TEXTDOMAIN); ?>
						</div>
						<div class="label">
						  <?php _e('Custom Part Display', TEXTDOMAIN); ?>
						</div>
					  </div>

					  <?php SwitchInput('custom_part_display', 'Disabled', 'Enabled'); ?>
					</div>
					<!-- Enabel Display Custom Part End -->
					
					<!--Custom Part label -->
					<div class="section">
						<div class="section-head">
						  <div class="section-tooltip">
							<?php _e('Enter custom part label here. It will be shown in menu navigation.', TEXTDOMAIN); ?>
						  </div>
						  <div class="label">
							<?php _e('Custom Part label', TEXTDOMAIN); ?>
						  </div>
						</div>

						<?php TextInput('custom_part_label', 'Custom Part label', 'field-spacer'); ?>
					...
					<!--Custom Part Position -->
					<div class="section">
						<div class="section-head">
							<div class="section-tooltip"><?php _e('You can select the custom part position.', TEXTDOMAIN); ?></div>
							<div class="label"><?php _e('Custom Part Position', TEXTDOMAIN); ?></div>
						</div>
						
						<?php $mailSecOpt = Array('1' => 'Before About', '2'=> 'Between About & Portfolio', '3' => 'Between Portfolio & Resume', '4' => 'Between Resume & contact', '5' => 'After Contact');
						SelectTag('custom_part_position', $mailSecOpt ); ?>
					</div>
					<!--Custom Part Position  End -->
					
				</div>	
				<!-- Custom Part Settings End -->
				...
				<!-- Resume Settings -->
				<div id="resume-settings" class="panel">
				  <div class="content-head">
					<h3>
					  <?php _e('Resume Settings', TEXTDOMAIN); ?>
					</h3>
					 <a href="#" class="save-button" ><span class="save">save</span>
					  <div class="tooltip">
						<div>
					...
					<!-- Enabel Display Resume  -->
					<div class="section">
					  <div class="section-head">
						<div class="section-tooltip">
						  <?php _e('Enable or disable resume section', TEXTDOMAIN); ?>
						</div>
						<div class="label">
						  <?php _e('Resume Display', TEXTDOMAIN); ?>
						</div>
					  </div>

					  <?php SwitchInput('resume_display', 'Disabled', 'Enabled'); ?>
					</div>
					<!-- Enabel Display Resume End -->
					
					<!--Resume label -->
					<div class="section">
						<div class="section-head">
						  <div class="section-tooltip">
							<?php _e('Enter resume label here. It will be shown in menu navigation.', TEXTDOMAIN); ?>
						  </div>
						  <div class="label">
							<?php _e('Resume Label', TEXTDOMAIN); ?>
						  </div>
						</div>

					<?php TextInput('resume_label', 'Resume label', 'field-spacer'); ?>
				...
				<div id="about-settings" class="panel">
				  <div class="content-head">
					...
					<!-- Enabel Display About  -->
					<div class="section">
					  <div class="section-head">
						<div class="section-tooltip">
						  <?php _e('Enable or disable about section', TEXTDOMAIN); ?>
						</div>
						<div class="label">
						  <?php _e('About Display', TEXTDOMAIN); ?>
						</div>
					  </div>

					  <?php SwitchInput('about_display', 'Disabled', 'Enabled'); ?>
					</div>
					<!-- Enabel Display About End -->
					
					<!--About label -->
					<div class="section">
						<div class="section-head">
						  <div class="section-tooltip">
							<?php _e('Enter about Label here. It will be shown in menu navigation.', TEXTDOMAIN); ?>
						  </div>
						  <div class="label">
							<?php _e('About Label', TEXTDOMAIN); ?>
						  </div>
						</div>

					<?php TextInput('about_label', 'About label', 'field-spacer'); ?>
